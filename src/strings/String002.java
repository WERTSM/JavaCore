...
public class String002 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("хэш объекта s1 = " + System.identityHashCode(s1) + "  хэш строки " + s1 + " = "
                + s1.hashCode());
        System.out.println("хэш объекта s2 = " + System.identityHashCode(s2) + "  хэш строки " + s2 + " = "
                + s2.hashCode());
        System.out.println("хэш объекта s3 = " + System.identityHashCode(s3) + "  хэш строки " + s3 + " = "
                + s3.hashCode());
        System.out.println("хэш объекта s4 = " + System.identityHashCode(s4) + "  хэш строки " + s4 + " = "
                + s4.hashCode());
        System.out.println("хэш объекта s5 = " + System.identityHashCode(s5) + "  хэш строки " + s5 + " = "
                + s5.hashCode());
        System.out.println("хэш объекта s6 = " + System.identityHashCode(s6) + "  хэш строки " + s6 + " = "
                + s6.hashCode());

        s3 = "world"; // создался новый объект в string pool
        System.out.println("\nстрока s1 = " + s1);  // строка s1 осталась неизмененной
        System.out.println("хэш объекта s3 = " + System.identityHashCode(s3) + " строка = " + s3);

        System.out.println();

        s6 = "Hello"; // ссылка на существующий объект в string pool
        System.out.println("хэш объекта s6 = " + System.identityHashCode(s6) + " строка = " + s6);

        System.out.println();

        s4 = s4.intern(); //ищется ссылка на существующий объект в string pool
        System.out.println("хэш объекта s4 = " + System.identityHashCode(s4) + " строка = " + s4);
