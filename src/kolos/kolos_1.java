...
public class kolos_1 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        BigDecimal t1 = BigDecimal.valueOf(1);
        BigDecimal t2 = BigDecimal.valueOf(1);
        BigDecimal t3 = BigDecimal.valueOf(1);
        BigDecimal t4 = BigDecimal.valueOf(1);
        ...
        for (w1 = BigDecimal.valueOf(5000.00); w1.compareTo(l1) <= 0; w1 = w1.add(t1)) {
            ...
            for (w2 = BigDecimal.valueOf(300.00); w2.compareTo(l2) <= 0; w2 = w2.add(t2)) {
                ...
                for (w3 = BigDecimal.valueOf(1.00); w3.compareTo(l3) <= 0; w3 = w3.add(t3)) {
                    for (w4 = BigDecimal.valueOf(1.00); w4.compareTo(l4) <= 0; w4 = w4.add(t4)) {
                        ...
                        tempresult = tempresult.add(z1).add(z2).add(z3).add(z4);
